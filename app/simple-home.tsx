...
export function SimpleHome() {
  ...
  console.log('🎯 SimpleHome: Rendering with', items.length, 'items, loading:', loading, 'error:', error, 'mounted:', mounted);
  ...
  useEffect(() => {
    ...
    console.log('🚀 SimpleHome: Starting initialization (mounted)...');
  ...
  return (
    <div className="min-h-screen bg-swiss-white">
      ...
      <div className="fixed bottom-4 right-4 bg-black text-white p-2 text-xs font-mono opacity-75">
        Items: {items.length} | Filtered: {filteredItems.length} | Loading: {loading ? 'Yes' : 'No'}
      </div>
